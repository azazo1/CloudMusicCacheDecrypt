...
@deprecation.deprecated(deprecated_in="0.9a2", removed_in="1.0", current_version=__version__,
                        details="Use meyed3.mimetype.guessMimetype() instead.")
...
class FileHandler(object):
    """A handler interface for :func:`meyed3.utils.walk` callbacks."""
...
class ArgumentParser(argparse.ArgumentParser):
    ...
    def __init__(self, *args, **kwargs):
        from meyed3 import version as VERSION
        from meyed3.utils.log import LEVELS
        from meyed3.utils.log import MAIN_LOGGER
...
def datePicker(thing, prefer_recording_date=False):
    ...
    and recording_date of type meyed3.core.Date).

...
class DateFrame(TextFrame):
    ...
    @date.setter
    def date(self, date):
        """Set value with a either an ISO 8601 date string or a meyed3.core.Date object."""
        if not date:
            self.text = ""
            return
        ...
        try:
            if type(date) is str:
                ...
                raise TypeError("str, int, or meyed3.core.Date type expected")
        except ValueError:

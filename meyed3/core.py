...
# (or album) a file belongs. See :class:`meyed3.core.ALBUM_TYPE_IDS`.
...
class AudioFile:
    ...
    def rename(self, name, fsencoding=LOCAL_FS_ENCODING,
        ...
        The encoding used for the file name is :attr:`meyed3.LOCAL_FS_ENCODING`
    ...
    @property
    def info(self):
        """Returns a concrete implemenation of :class:`meyed3.core.AudioInfo`"""
        return self._info

    @property
    def tag(self):
        """Returns a concrete implemenation of :class:`meyed3.core.Tag`"""
        return self._tag
    ...
    def __init__(self, path):
        ...
        from meyed3.id3.tag import Tag as ITag
        self.type = None
        self._info = None
        self._tag = None  # type:ITag
        self._read()
...
def load(path, tag_version=None) -> AudioFile:
    ...
    :class:`meyed3.core.AudioFile`. If ``path`` is not a file an ``IOError`` is
    raised. ``None`` is returned when the file type (i.e. mime-type) is not
    recognized.
    The following AudioFile types are supported:

      * :class:`meyed3.mp3.Mp3AudioFile` - For mp3 audio files.
      * :class:`meyed3.id3.TagFile` - For raw ID3 data files.

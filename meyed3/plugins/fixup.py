...
from meyed3 import core
from meyed3.core import (ALBUM_TYPE_IDS, TXXX_ALBUM_TYPE, EP_MAX_SIZE_HINT,
                         LP_TYPE, EP_TYPE, COMP_TYPE, VARIOUS_TYPE, DEMO_TYPE,
                         LIVE_TYPE, SINGLE_TYPE, VARIOUS_ARTISTS)
from meyed3.id3 import ID3_V2_4
from meyed3.id3.tag import TagTemplate
from meyed3.plugins import LoaderPlugin
from meyed3.utils import art
from meyed3.utils.console import printMsg, Style, Fore
from meyed3.utils.prompt import prompt
...
""" % globals()
    ...
    def start(self, args, config):
        import meyed3.utils.prompt
        meyed3.utils.prompt.DISABLE_PROMPT = "exit" if args.no_prompt else None
